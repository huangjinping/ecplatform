/* **************************************************************
 *
 * 文件名称：OrgUserService.java
 *
 * 包含类名：cn.cooperlink.ecplatform.system.service.OrgUserService
 * 创建日期：2014年8月9日
 * 创建作者：潘云峰
...
@Service
@Transactional
public class OrgUserService extends BaseService4Mapper {
    ...
    @Override
    public OrgUserMapper getMapper() {
